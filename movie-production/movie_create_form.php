...
<body class="container flex flex-column">
    ...
    <main class="main">
        <form method="post" class="form">
            ...
            <input id="title" type="text" name="title" class="title" value="<?php if(isset($data["title"])) echo $data["title"];?>">
            <div class="error"></div>

            <label for="director" class="label">Director</label>
            <input id="director" type="text" name="director" class="narrow" value="">
            <input id="director" type="text" name="director" class="narrow" value="<?php if(isset($data["director"])) echo $data[""];?>">
            <div class="error"></div>
            ...
            <div class="wide">
                <input id="1-star" type="radio" name="rating" value="12">
